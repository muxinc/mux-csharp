...
# **ListFilterValues**
> ListFilterValuesResponse ListFilterValues (string FILTER_ID, int? limit = null, int? page = null, List<string> filters = null, List<string> timeframe = null)
...
namespace Example
{
    public class ListFilterValuesExample
    {
        public static void Main()
        {
            ...
            var FILTER_ID = abcd1234;  // string | ID of the Filter
            ...
            {
                Debug.Print("Exception when calling FiltersApi.ListFilterValues: " + e.Message );
...
namespace Example
{
    public class ListFiltersExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FiltersApi.ListFilters: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
