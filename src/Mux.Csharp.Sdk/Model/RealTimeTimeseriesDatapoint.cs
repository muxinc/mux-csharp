...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RealTimeTimeseriesDatapoint")]
    public partial class RealTimeTimeseriesDatapoint : IEquatable<RealTimeTimeseriesDatapoint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RealTimeTimeseriesDatapoint" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RealTimeTimeseriesDatapoint);
        }

        /// <summary>
        /// Returns true if RealTimeTimeseriesDatapoint instances are equal
        /// </summary>
        /// <param name="input">Instance of RealTimeTimeseriesDatapoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RealTimeTimeseriesDatapoint input)
        {
            if (input == null)
            {
                return false;
