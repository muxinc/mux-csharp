...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// WebInput
    /// </summary>
    [DataContract(Name = "WebInput")]
    public partial class WebInput : IEquatable<WebInput>, IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        public WebInput(string id = default(string), string createdAt = default(string), string url = default(string), bool autoLaunch = default(bool), string liveStreamId = default(string), StatusEnum? status = default(StatusEnum?), string passthrough = default(string), ResolutionEnum? resolution = ResolutionEnum._1920x1080, int timeout = 3600)
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as WebInput);
        }

        /// <summary>
        /// Returns true if WebInput instances are equal
        /// </summary>
        /// <param name="input">Instance of WebInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebInput input)
        {
            if (input == null)
            {
                return false;
