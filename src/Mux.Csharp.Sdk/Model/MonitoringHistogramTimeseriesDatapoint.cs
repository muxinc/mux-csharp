...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MonitoringHistogramTimeseriesDatapoint")]
    public partial class MonitoringHistogramTimeseriesDatapoint : IEquatable<MonitoringHistogramTimeseriesDatapoint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonitoringHistogramTimeseriesDatapoint" /> class.
        /// </summary>
        ...
        public List<MonitoringHistogramTimeseriesBucketValues> BucketValues { get; set; }
        ...
        {
            return this.Equals(input as MonitoringHistogramTimeseriesDatapoint);
        }

        /// <summary>
        /// Returns true if MonitoringHistogramTimeseriesDatapoint instances are equal
        /// </summary>
        /// <param name="input">Instance of MonitoringHistogramTimeseriesDatapoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MonitoringHistogramTimeseriesDatapoint input)
        {
            if (input == null)
            {
                return false;
