...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MonitoringBreakdownValue")]
    public partial class MonitoringBreakdownValue : IEquatable<MonitoringBreakdownValue>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MonitoringBreakdownValue" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as MonitoringBreakdownValue);
        }

        /// <summary>
        /// Returns true if MonitoringBreakdownValue instances are equal
        /// </summary>
        /// <param name="input">Instance of MonitoringBreakdownValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MonitoringBreakdownValue input)
        {
            if (input == null)
            {
                return false;
