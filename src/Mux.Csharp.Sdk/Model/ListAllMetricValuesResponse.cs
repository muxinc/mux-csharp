...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListAllMetricValuesResponse")]
    public partial class ListAllMetricValuesResponse : IEquatable<ListAllMetricValuesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAllMetricValuesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        public ListAllMetricValuesResponse(List<Score> data = default(List<Score>), long totalRowCount = default(long), List<long> timeframe = default(List<long>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as ListAllMetricValuesResponse);
        }

        /// <summary>
        /// Returns true if ListAllMetricValuesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListAllMetricValuesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListAllMetricValuesResponse input)
        {
            if (input == null)
            {
                return false;
