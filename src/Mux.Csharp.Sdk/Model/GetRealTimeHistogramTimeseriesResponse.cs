...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetRealTimeHistogramTimeseriesResponse")]
    public partial class GetRealTimeHistogramTimeseriesResponse : IEquatable<GetRealTimeHistogramTimeseriesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetRealTimeHistogramTimeseriesResponse" /> class.
        /// </summary>
        ...
        public GetRealTimeHistogramTimeseriesResponseMeta Meta { get; set; }

        /// <summary>
        /// Gets or Sets Data
        /// </summary>
        [DataMember(Name = "data", EmitDefaultValue = false)]
        public List<RealTimeHistogramTimeseriesDatapoint> Data { get; set; }
        ...
        {
            return this.Equals(input as GetRealTimeHistogramTimeseriesResponse);
        }

        /// <summary>
        /// Returns true if GetRealTimeHistogramTimeseriesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetRealTimeHistogramTimeseriesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetRealTimeHistogramTimeseriesResponse input)
        {
            if (input == null)
            {
                return false;
