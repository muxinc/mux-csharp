...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// IncidentResponse
    /// </summary>
    [DataContract(Name = "IncidentResponse")]
    public partial class IncidentResponse : IEquatable<IncidentResponse>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as IncidentResponse);
        }

        /// <summary>
        /// Returns true if IncidentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IncidentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IncidentResponse input)
        {
            if (input == null)
            {
                return false;
