...
namespace Mux.Csharp.Sdk.Model
{
    ...
    public partial class RealTimeBreakdownValue : IEquatable<RealTimeBreakdownValue>, IValidatableObject
    {
        ...
        public RealTimeBreakdownValue(string value = default(string), long negativeImpact = default(long), double? metricValue = default(double?), string displayValue = default(string), long concurrentViewers = default(long), long startingUpViewers = default(long))
        {
            this.Value = value;
