...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListInsightsResponse")]
    public partial class ListInsightsResponse : IEquatable<ListInsightsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListInsightsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        /// <param name="meta">meta.</param>
        public ListInsightsResponse(List<Insight> data = default(List<Insight>), long totalRowCount = default(long), List<long> timeframe = default(List<long>), ListBreakdownValuesResponseMeta meta = default(ListBreakdownValuesResponseMeta))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as ListInsightsResponse);
        }

        /// <summary>
        /// Returns true if ListInsightsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListInsightsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListInsightsResponse input)
        {
            if (input == null)
            {
                return false;
