...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// VideoViewResponse
    /// </summary>
    [DataContract(Name = "VideoViewResponse")]
    public partial class VideoViewResponse : IEquatable<VideoViewResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VideoViewResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as VideoViewResponse);
        }

        /// <summary>
        /// Returns true if VideoViewResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of VideoViewResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VideoViewResponse input)
        {
            if (input == null)
            {
                return false;
