...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListRelatedIncidentsResponse")]
    public partial class ListRelatedIncidentsResponse : IEquatable<ListRelatedIncidentsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListRelatedIncidentsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        public ListRelatedIncidentsResponse(List<Incident> data = default(List<Incident>), long totalRowCount = default(long), List<long> timeframe = default(List<long>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as ListRelatedIncidentsResponse);
        }

        /// <summary>
        /// Returns true if ListRelatedIncidentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListRelatedIncidentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListRelatedIncidentsResponse input)
        {
            if (input == null)
            {
                return false;
