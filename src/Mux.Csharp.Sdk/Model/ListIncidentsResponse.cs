...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListIncidentsResponse")]
    public partial class ListIncidentsResponse : IEquatable<ListIncidentsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListIncidentsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        public ListIncidentsResponse(List<Incident> data = default(List<Incident>), long totalRowCount = default(long), List<long> timeframe = default(List<long>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as ListIncidentsResponse);
        }

        /// <summary>
        /// Returns true if ListIncidentsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListIncidentsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListIncidentsResponse input)
        {
            if (input == null)
            {
                return false;
