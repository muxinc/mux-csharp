...
namespace Mux.Csharp.Sdk.Model
{
    ...
    public partial class ListRealTimeDimensionsResponse : IEquatable<ListRealTimeDimensionsResponse>, IValidatableObject
    {
        ...
        public ListRealTimeDimensionsResponse(List<ListRealTimeDimensionsResponseData> data = default(List<ListRealTimeDimensionsResponseData>), long totalRowCount = default(long), List<long> timeframe = default(List<long>))
        {
            this.Data = data;
