...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListVideoViewExportsResponse")]
    public partial class ListVideoViewExportsResponse : IEquatable<ListVideoViewExportsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListVideoViewExportsResponse" /> class.
        /// </summary>
        ...
        public List<ExportDate> Data { get; set; }
        ...
        {
            return this.Equals(input as ListVideoViewExportsResponse);
        }

        /// <summary>
        /// Returns true if ListVideoViewExportsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListVideoViewExportsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListVideoViewExportsResponse input)
        {
            if (input == null)
            {
                return false;
