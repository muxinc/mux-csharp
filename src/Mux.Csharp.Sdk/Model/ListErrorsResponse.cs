...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// ListErrorsResponse
    /// </summary>
    [DataContract(Name = "ListErrorsResponse")]
    public partial class ListErrorsResponse : IEquatable<ListErrorsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListErrorsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        public ListErrorsResponse(List<Error> data = default(List<Error>), long? totalRowCount = default(long?), List<long> timeframe = default(List<long>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as ListErrorsResponse);
        }

        /// <summary>
        /// Returns true if ListErrorsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListErrorsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListErrorsResponse input)
        {
            if (input == null)
            {
                return false;
