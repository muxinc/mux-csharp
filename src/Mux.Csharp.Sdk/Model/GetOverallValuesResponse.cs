...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GetOverallValuesResponse")]
    public partial class GetOverallValuesResponse : IEquatable<GetOverallValuesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetOverallValuesResponse" /> class.
        /// </summary>
        ...
        public OverallValues Data { get; set; }
        ...
        {
            return this.Equals(input as GetOverallValuesResponse);
        }

        /// <summary>
        /// Returns true if GetOverallValuesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetOverallValuesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetOverallValuesResponse input)
        {
            if (input == null)
            {
                return false;
