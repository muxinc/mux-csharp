...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListFilterValuesResponse")]
    public partial class ListFilterValuesResponse : IEquatable<ListFilterValuesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListFilterValuesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        public ListFilterValuesResponse(List<FilterValue> data = default(List<FilterValue>), long totalRowCount = default(long), List<long> timeframe = default(List<long>))
        {
            this.Data = data;
        ...
        public List<FilterValue> Data { get; set; }
        ...
        {
            return this.Equals(input as ListFilterValuesResponse);
        }

        /// <summary>
        /// Returns true if ListFilterValuesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListFilterValuesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListFilterValuesResponse input)
        {
            if (input == null)
            {
                return false;
