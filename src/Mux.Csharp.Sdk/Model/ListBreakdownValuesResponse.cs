...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListBreakdownValuesResponse")]
    public partial class ListBreakdownValuesResponse : IEquatable<ListBreakdownValuesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListBreakdownValuesResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        /// <param name="meta">meta.</param>
        public ListBreakdownValuesResponse(List<BreakdownValue> data = default(List<BreakdownValue>), long totalRowCount = default(long), List<long> timeframe = default(List<long>), ListBreakdownValuesResponseMeta meta = default(ListBreakdownValuesResponseMeta))
        {
            this.Data = data;
        ...
        public List<BreakdownValue> Data { get; set; }
        ...
        {
            return this.Equals(input as ListBreakdownValuesResponse);
        }

        /// <summary>
        /// Returns true if ListBreakdownValuesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListBreakdownValuesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListBreakdownValuesResponse input)
        {
            if (input == null)
            {
                return false;
