...
namespace Mux.Csharp.Sdk.Model
{
    ...
    /// ListExportsResponse
    /// </summary>
    [DataContract(Name = "ListExportsResponse")]
    public partial class ListExportsResponse : IEquatable<ListExportsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListExportsResponse" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="totalRowCount">totalRowCount.</param>
        /// <param name="timeframe">timeframe.</param>
        public ListExportsResponse(List<string> data = default(List<string>), long? totalRowCount = default(long?), List<long> timeframe = default(List<long>))
        {
            this.Data = data;
        ...
        {
            return this.Equals(input as ListExportsResponse);
        }

        /// <summary>
        /// Returns true if ListExportsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListExportsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListExportsResponse input)
        {
            if (input == null)
            {
                return false;
